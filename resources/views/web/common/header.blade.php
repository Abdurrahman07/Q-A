...
<head>
   ...
   <link rel="stylesheet" href="/ask/web/css/default.css">
	<link rel="stylesheet" href="/ask/web/css/layout.css">
   <link rel="stylesheet" href="/ask/web/css/media-queries.css">


   <!-- Script
   ================================================== -->
	<script src="/ask/web/js/modernizr.js"></script>

   <!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="/ask/web/favicon.ico" > 
   ...
   <header>
      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <div class="logo">
               <a href="index.html"><img alt="" src="/ask/web/images/logo.png"></a>
            </div>
			   ...
			   <li>
				   <div class="row">
                     ...
                     <div class="slider-image">
                        <img src="/ask/web/images/sliders/home-slider-image-01.png" alt="" />
                     </div>
					   </div>
				   </div>
			   </li>
            ...
            <!-- Slide -->
			   <li>
				   <div class="row">
                     ...
                     <div class="slider-image">
                        <img src="/ask/web/images/sliders/home-slider-image-02.png" alt="" />
                     </div>
					   </div>
				   </div>
			   </li>
